    ...
    if (Object.keys(config).length === 0) {
      ...
      if (ENV === "development") {
        config = {
          ...
          WECHAT_APP_SECRET:
            process.env.VUE_APP_WECHAT_APP_SECRET || "wx_dev_app_secret",
          OSS_ACCESS_KEY:
            process.env.VUE_APP_OSS_ACCESS_KEY || "dev_access_key",
          OSS_SECRET_KEY:
            process.env.VUE_APP_OSS_SECRET_KEY || "dev_secret_key",
      ...
      // 测试环境
        ...
        config = {
          API_BASE_URL:
            ...
            "https://test-api.your-domain.com",
          API_TIMEOUT: process.env.VUE_APP_API_TIMEOUT || 15000,
          WECHAT_APP_ID: process.env.VUE_APP_WECHAT_APP_ID || "wx_test_app_id",
          WECHAT_APP_SECRET:
            process.env.VUE_APP_WECHAT_APP_SECRET || "wx_test_app_secret",
          OSS_ACCESS_KEY:
            process.env.VUE_APP_OSS_ACCESS_KEY || "test_access_key",
          OSS_SECRET_KEY:
            process.env.VUE_APP_OSS_SECRET_KEY || "test_secret_key",
      ...
      // 生产环境
        ...
        config = {
          ...
          WECHAT_APP_SECRET:
            process.env.VUE_APP_WECHAT_APP_SECRET || "wx_prod_app_secret",
          OSS_ACCESS_KEY:
            process.env.VUE_APP_OSS_ACCESS_KEY || "prod_access_key",
          OSS_SECRET_KEY:
            process.env.VUE_APP_OSS_SECRET_KEY || "prod_secret_key",
